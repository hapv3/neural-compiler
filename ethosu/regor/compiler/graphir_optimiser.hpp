...
private:
    ...
    Operation *RewriteReduceMin(Graph *const graph, Operation *const operation);
    ...
    {{
        ...
        },
        {
            {},
            {
                ...
                &GraphIrOptimiser::RewriteReduceMin,
