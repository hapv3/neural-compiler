...
//
// Automatically generated by tosaValidationGenerator for TOSA Specification 1.0.0
// Do not edit.
...
void ValidateOperator(const GraphApi::GraphOperation *graphOp, const Context &context)
{
    ...
    if ( (context.version & 0xFFFFFF00) == GraphApi::VERSION_TOSA_1_00 && context.profile == GraphApi::PROFILE_INT )
    {
        ValidateOperator_Version_1_0_0_Profile_PRO_INT(graphOp, context);
        return;
    }
