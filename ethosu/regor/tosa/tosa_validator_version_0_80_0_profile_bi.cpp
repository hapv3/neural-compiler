...
//
// Generated by tosaValidationGenerator for tosa specification 0.80.0
// Do not edit.
...
void ValidateOperator_AVG_POOL2D(const regor::Operation *op, const Context &context)
{
    ...
    ValidateArguments(op, arguments, typesupports, context);
    ErrorIfCheck_4tfs5fdsigv(op, context);
...
void ValidateOperator_CONV2D(const regor::Operation *op, const Context &context)
{
    ...
    const Argument weight = {Category::Input, "weight", "weight_t", {4, 4}}; /*Weight kernel size KH x KW
                                                                                shape=[OC,KH,KW,IC]*/
    const Argument bias = {Category::Input, "bias", "out_t", {1, 1}};   /*Per output channel bias data. shape=[BC]*/
    const Argument pad = {Category::Attribute, "pad", "i32_t", {1, 1}}; /*[pad_top, pad_bottom, pad_left, pad_right]
                                                                           shape=[4]*/
    const Argument stride = {Category::Attribute, "stride", "i32_t", {1, 1}};     /*[stride_y, stride_x] shape=[2]*/
    ...
    ValidateArguments(op, arguments, typesupports, context);
    ErrorIfCheck_2p5uniza3kjyg(op, context);
...
void ValidateOperator_FULLY_CONNECTED(const regor::Operation *op, const Context &context)
{
    ...
    const Argument weight = {Category::Input, "weight", "weight_t", {2, 2}}; /*Weights shape=[OC,IC]*/
    const Argument bias = {Category::Input, "bias", "out_t", {1, 1}}; /*Per output channel bias data. shape=[BC]*/
    const Argument input_zp = {
        Category::ScalarAttribute,
        "input_zp",
...
void ValidateOperator_MATMUL(const regor::Operation *op, const Context &context)
{
    ...
    ValidateArguments(op, arguments, typesupports, context);
    ErrorIfCheck_28csiz8foar64(op, context);
...
void ValidateOperator_TRANSPOSE_CONV2D(const regor::Operation *op, const Context &context)
{
    ...
    const Argument out_pad = {Category::Attribute, "out_pad", "i32_t", {1, 1}};     /*[out_pad_top, out_pad_bottom,
                                                                                       ...
                                                                                       shape=[4]*/
    const Argument stride = {Category::Attribute, "stride", "i32_t", {1, 1}};       /*[stride_y, stride_x] shape=[2]*/
    const Argument out_shape = {Category::Attribute, "out_shape", "i32_t", {1, 1}}; /*[N,OH,OW,OC] shape=[4]*/
    const Argument input_zp = {
        Category::ScalarAttribute,
        "input_zp",
        "in_t",
...
void ValidateOperator_ADD(const regor::Operation *op, const Context &context)
{
    ...
    const Argument input2 = {Category::Input, "input2", "in_out_t", {0, MAX_RANK}}; /*Input tensor with the same rank as
                                                                                       input1 shape=shape2*/
    const Argument output = {Category::Output, "output", "in_out_t", {0, MAX_RANK}}; /*Output tensor with broadcast
                                                                                        shape if necessary shape=shape*/
    const std::vector<const Argument *> arguments = {
        &input1,
        &input2,
        &output,
    ...
    ValidateArguments(op, arguments, typesupports, context);
    ErrorIfCheck_3tu2mqt96ickt(op, context);
...
void ValidateOperator_MUL(const regor::Operation *op, const Context &context)
{
    ...
    const Argument output = {Category::Output, "output", "out_t", {0, MAX_RANK}}; /*Output tensor with broadcast shape
                                                                                     if necessary shape=shape*/
    const std::vector<const Argument *> arguments = {
        &input1,
        &input2,
        &shift,
...
void ValidateOperator_NEGATE(const regor::Operation *op, const Context &context)
{
    ...
    ValidateArguments(op, arguments, typesupports, context);
    ErrorIfCheck_1advtk54oueo2(op, context);
    ErrorIfCheck_3nav30dsmv6gd(op, context);
    ErrorIfCheck_396rg8p65j58r(op, context);
    LevelCheck_1flzmpv6hubzc(op, context);
}
...
{
    const Argument input = {Category::Input, "input", "in_out_t", {1, MAX_RANK}}; /*Input tensor with rank from 1 to 4
                                                                                     shape=shape1*/
    const Argument axis = {
        Category::ScalarAttribute,
        "axis",
...
{
    const Argument input1 = {Category::Input, "input1", "in_out_t", {0, MAX_RANK}}; /*List of input tensors. All inputs
...
void ValidateOperator_PAD(const regor::Operation *op, const Context &context)
{
    ...
    const Argument padding = {Category::Input, "padding", "shape_t", {2, 2}}; /*Number of pad elements at the start and
...
{
    const Argument input = {Category::Input, "input", "in_out_t", {1, MAX_RANK}}; /*Input tensor shape=shape*/
    const Argument axis = {
        Category::ScalarAttribute,
        "axis",
        "i32_t",
...
{
    const Argument input1 = {Category::Input, "input1", "in_out_t", {1, MAX_RANK}}; /*Input tensor shape=shape1*/
    const Argument start = {Category::Attribute, "start", "index_t", {1, 1}}; /*List of integer coordinates, of length
                                                                               equal to the rank of input1. Start
                                                                               coordinate for slicing.
                                                                               shape=[rank(shape1)]*/
    const Argument size = {Category::Attribute, "size", "index_t", {1, 1}};   /*List of integer size values, of length
...
void ValidateOperator_RESCALE(const regor::Operation *op, const Context &context)
{
    ...
    const Argument input_zp = {
        ...
        "input_zp",
        "in_t",
    }; /*Input tensor zero point. int8/uint8 can have zero point within their valid range. uint16 zero point must be
        either 0 or 32768. All other types must have zero point equal to 0. */
    const Argument output_zp = {
        Category::ScalarAttribute,
        "output_zp",
        "out_t",
    }; /*Output tensor zero point.int8/uint8 can have zero point within their valid range. uint16 zero point must be
        either 0 or 32768. All other types must have zero point equal to 0. */
    ...
    ValidateArguments(op, arguments, typesupports, context);
    ErrorIfCheck_1wbutqm1lq6qy(op, context);
    ErrorIfCheck_2x883ovw61v55(op, context);
    ErrorIfCheck_7yfu5xo1ii36(op, context);
    ErrorIfCheck_3kc0n1wjhehqz(op, context);
...
void ValidateOperator_CUSTOM(const regor::Operation *op, const Context &context)
{
    ...
    const Argument domain = {
        ...
        "domain",
        "-",
    }; /*String idenifier which can help avoid name collisions on the operator field. Different implementations of a
...
{
    const Argument condition = {Category::Input, "condition", "bool_t", {1, MAX_RANK}}; /*Input condition as a size 1
                                                                                           tensor shape=shape*/
    const Argument input_list = {
        Category::Input,
        "input_list",
