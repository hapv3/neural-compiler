...
static const char *ERRORIF_BroadcastShapesMismatch = "Broadcast shape calculating failed";
...
static const char *ERRORIF_InputRank1WrongRank = "Rank not supported for rank 0 input";
...
static const char *ERRORIF_KernelSmallerOne = "At least one kernel dimension is smaller than zero";
...
static const char *ERRORIF_ScaleSmallerEqualZero = "Scale value smaller than or equal zero";
...
static const char *ERRORIF_StrideSmallerOne = "At least one stride dimension is smaller than zero";
static const char *ERRORIF_TensorSizeInputOutputMismatch = "Input tensor size does not match output tensor size";
static const char *ERRORIF_TileMultiplesOutputShapeMismatch = "Multiples does not match output shape";
static const char *ERRORIF_TransposePermsOutputShapeMismatch = "Permutations does not match output shape";
static const char *ERRORIF_U16InputZeroPointNotValid = "Input DType is UINT16 and zero point not 0 or 32678";
static const char *ERRORIF_U16OutputZeroPointNotValid = "Output DType is UINT16 and zero point not 0 or 32678";
